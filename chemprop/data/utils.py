    ...
    with open(path) as f:
        ...
        data = MoleculeDataset([
            MoleculeDatapoint(
                ...
                overwrite_default_atom_descriptors=args.overwrite_default_atom_descriptors if args is not None else False,
                overwrite_default_bond_descriptors=args.overwrite_default_bond_descriptors if args is not None else False
