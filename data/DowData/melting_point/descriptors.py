...
def generate_starting_files(infile='combined_temp_v2.csv',
                           out_folder='Lipinski_AllData',
                           descriptor_type='lipinski'): ## lipinski, joback, thermo, thermo_dipole, morgan,rdkit, hansen,thermo_viscosity,thermo_surface_tension,thermo_skin_toxicity
    ...
    if descriptor_type == 'lipinski':
        ...
        data[['SMILES','MP']].to_csv(os.path.join(out_folder,'data.csv'),index=None)
